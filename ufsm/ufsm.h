...
DLL_API const char *ufsm_state_kinds[];

DLL_API const char *ufsm_errors[];
...
DLL_API ufsm_status_t ufsm_init_machine(struct ufsm_machine *m);
DLL_API ufsm_status_t ufsm_reset_machine(struct ufsm_machine *m);
DLL_API ufsm_status_t ufsm_process(struct ufsm_machine *m, int32_t ev, struct ufsm_context* event_context);
DLL_API ufsm_status_t ufsm_process_auto(struct ufsm_machine *m, int32_t ev, struct ufsm_context* event_context);
...
DLL_API ufsm_status_t ufsm_queue_get(struct ufsm_queue *q, uint32_t *ev);
DLL_API struct ufsm_queue * ufsm_get_queue(struct ufsm_machine *m);
DLL_API void ufsm_debug_machine(struct ufsm_machine *m);
